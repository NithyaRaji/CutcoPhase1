...
let Homepage = function () {
   ...
   this.homePage = element(by.className('md ion-page hydrated'));
   this.notificationOverlay = element(by.className('modal-wrapper md sc-ion-modal-md'));
   this.notificationOverlayMsg = element(by.className('ios list-ios list-lines-full list-ios-lines-full hydrated'));
   //this.notificationCount = element(by.xpath(".//*[@class='ios list-ios list-lines-full list-ios-lines-full hydrated']/cc-message"));
   this.cutcoLogoNew = element(by.xpath('cc-logo-header cc-logo-header-cutco'));
   ...
   this.resumeOrderMore = element(by.css(".option-menu-wrapper"));
   this.moreDeleteButton = element(by.css(".option-content-wrapper"));
   this.deleteCommentButton = element(by.css('.delete.button'));
   ...
   this.notificationBadgeCount = element(by.id('messageCountBadge'));
   this.notificationOverlayCount = element.all(by.xpath(".//ion-list/cc-message"));

...
describe('RA-2922- In Vector US, Verify whether Payment options that are not valid for the currently configured pricing model will be shown in the Shipping and Payment page but should be in a disabled state', function () {
    ...
    it('RA-2922 - Context Switcher - Vector US', function () {

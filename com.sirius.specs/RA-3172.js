...
describe('RA-3172 - Verify whether When an order is saved, the configured bonus limit is saved with the order.', function () {
    ...
    it('RA-3172 - Context Switcher - Vector US', function () {
    ...
    it('RA-3172 - Context Switcher - Vector CA', function () {
        loginApp.loginAppDefault();
        homePage.verfiyHomePage();
    ...
    it('RA-3172 - Context Switcher - Cutco US', function () {
        loginApp.loginAppDefault();
        homePage.verfiyHomePage();

...
describe('RA-2909 - verify whether user able to break down a pending order set product', function () {
    ...
    it('RA-2909 - Context Switcher - Vector US', function () {
    ...
    it('RA-2909 - Context Switcher - Vector CA', function () {
        loginApp.loginAppDefault();
        homePage.verfiyHomePage();
    ...
    it('RA-2909 - Context Switcher - Cutco US', function () {
        loginApp.loginAppDefault();
        homePage.verfiyHomePage();

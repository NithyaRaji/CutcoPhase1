...
describe('RA-3228 - verify whether When an image is attached to the order: The “Select” text link is replaced by a “Remove X” text link', function () {
    ...
    it('RA-3228 - Context Switcher - Vector US', function () {
        ...
        expect(element(by.xpath("//div[@class='image-btn'][contains(text(),'Select')]")).isPresent()).toBeFalsy();
